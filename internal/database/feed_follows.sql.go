...
SELECT users.name AS "user_name", feeds.name AS "feed_name", feed_follows.id, feed_follows.created_at, feed_follows.updated_at, feed_follows.user_id, feed_follows.feed_id
FROM users
